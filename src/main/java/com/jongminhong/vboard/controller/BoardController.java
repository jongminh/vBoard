package com.jongminhong.vboard.controller;
...
import com.jongminhong.vboard.dto.RegistrationForm;
import com.jongminhong.vboard.entity.Board;
import com.jongminhong.vboard.repository.BoardRepository;
...
public class BoardController {
	...
	public String showBoard(@PathVariable("boardName") String boardName, Model model) {
		...
		if(boardRepository.findByName(boardName) == null){
	...
	public String registerBoard(@Valid RegistrationForm registrationForm,
		...
		System.out.println("Board: " + request.getParameter("boardName"));
